...
set "SRC=src/main.cpp src/lexer.cpp src/parser.cpp src/codegen.cpp src/codegen_pe.cpp src/codegen_builtins.cpp src/codegen_gui.cpp src/codegen_dx11.cpp src/codegen_sw.cpp src/codegen_efi.cpp src/optimizer.cpp"
set "SRCW=src\\main.cpp src\\lexer.cpp src\\parser.cpp src\\codegen.cpp src\\codegen_pe.cpp src\\codegen_builtins.cpp src\\codegen_gui.cpp src\\codegen_dx11.cpp src\\codegen_sw.cpp src\\codegen_efi.cpp src\\optimizer.cpp"

REM --- проверка, что запускамся из корня проекта ---
